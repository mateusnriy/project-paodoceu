  ...
  const renderTableContent = () => {
    ...
    return (
        <table className="min-w-full divide-y divide-gray-200 relative"> {/* Adicionado relative */}
            ...
            <div className="absolute inset-0 bg-white bg-opacity-50 flex items-center justify-center z-10 rounded-b-4xl"> {/* Rounded bottom */}
            ...
            <thead>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Email (Usuário)</th>
